\chapter{Shogoki: Deterministic Execution System} \label{chap:detexec}
...
\label{fig:profiled}
\end{figure}
% put a bb with profile instrumentation here
