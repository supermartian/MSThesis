...
plot "redis_c2.csv" u ($0-0.25):4:xtic(1) title "Linux" with boxes, \
     "redis_c2.csv" u 0:3 title "FT-Popcorn Deterministic Execution" with boxes, \
     "redis_c2.csv" u ($0+0.25):2 title "FT-Popcorn Schedule Replication" with boxes
...
plot "redis_c16.csv" u ($0-0.25):4:xtic(1) title "Linux" with boxes, \
     "redis_c16.csv" u 0:3 title "FT-Popcorn Deterministic Execution" with boxes, \
     "redis_c16.csv" u ($0+0.25):2 title "FT-Popcorn Schedule Replication" with boxes
...
plot "redis_c64.csv" u ($0-0.25):4:xtic(1) title "Linux" with boxes, \
     "redis_c64.csv" u 0:3 title "FT-Popcorn Deterministic Execution" with boxes, \
     "redis_c64.csv" u ($0+0.25):2 title "FT-Popcorn Schedule Replication" with boxes
