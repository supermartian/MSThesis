...
\@x{ Less ( p ,\, tp ,\, q ,\, tq ) \.{\defeq}}%
 \@x{\@s{19.35} tp \.{<} tq \.{\lor} ( tp \.{=} tq \.{\land} PID ( p )
 \.{\leq} PID ( q ) )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{ TcpData \.{\defeq} 1 \.{\dotdot} StreamLength \.{*} Requests}%
 ...
 \.{\mapsto}}%
 \@x{\@s{49.19} ( [ i \.{\in} 1 \.{\dotdot} StreamLength \.{\mapsto} i \.{+} (
 StreamLength \.{*} ( r \.{-} 1 ) ) ] ) ]}%
...
\@x{ Shift ( s ) \.{\defeq}}%
\@x{\@s{16.4} {\IF} Len ( s ) \.{>} 1}%
 \@x{\@s{16.4} \.{\THEN} [ i \.{\in} 1 \.{\dotdot} ( Len ( s ) \.{-} 1 )
 \.{\mapsto} s [ i \.{+} 1 ] ]}%
\@x{\@s{16.4} \.{\ELSE} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Shiftn ( s ) \.{\defeq}}%
\@x{\@s{16.4} {\IF} Len ( s ) \.{>} 1}%
 \@x{\@s{16.4} \.{\THEN} [ i \.{\in} 1 \.{\dotdot} ( Len ( s ) \.{-} 1 )
 \.{\mapsto} s [ i \.{+} 1 ] ]}%
\@x{\@s{16.4} \.{\ELSE} {\langle} \.{-} 1 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\@s{32.8} status \.{=} [ p \.{\in} P \.{\mapsto}\@w{running} ] ,\,}%
\@x{\@s{32.8} ltime \.{=} [ p \.{\in} P \.{\mapsto} InitLogTime ] ,\,}%
 \@x{\@s{32.8} file \.{=} [ k \.{\in} Kernel \.{\mapsto} {\langle} {\rangle} ]
 ,\,}%
\@x{\@s{32.8} bumps \.{=} [ p \.{\in} Pid \.{\mapsto} \{ \} ] ,\,}%
\@x{\@s{32.8} reads\@s{5.23} \.{=} [ p \.{\in} P \.{\mapsto} \.{-} 1 ] ,\,}%
 \@x{\@s{32.8} tcpBuff \.{=} [ k \.{\in} Kernel \.{\mapsto} TcpMultiStream ]
 ,\,}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{32.8} socketQueue \.{=} [ k \.{\in} Kernel \.{\mapsto} {\langle}
 {\rangle} ] ,\,}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{32.8} requestQueue \.{=} [ k \.{\in} Kernel \.{\mapsto} [ r \.{\in} 1
 \.{\dotdot} Requests \.{\mapsto} r ] ] ,\,}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 The socket that is handled by a process
}%
\@xx{}%
\@x{\@s{32.8} handledSocket \.{=} [ p \.{\in} P \.{\mapsto} \.{-} 1 ] ,\,}%
 \@x{\@s{32.8} connections \.{=} [ k \.{\in} Kernel \.{\mapsto} {\langle}
 {\rangle} ]}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@define} \{}%
\@x{\@s{32.8} Run ( p ) \.{\defeq} status [ p ] \.{=}\@w{running}}%
 \@x{\@s{32.8} Running ( kernel ) \.{\defeq} \{ p \.{\in} OnKernel ( kernel )
 \.{:} Run ( p ) \}}%
\@x{\@s{32.8} WaitingSync ( kernel ) \.{\defeq}}%
 \@x{\@s{49.19} \{ p \.{\in} OnKernel ( kernel ) \.{:} status [ p ]
 \.{=}\@w{waiting\ sync} \}}%
\@x{\@s{32.8} WaitingRead ( kernel ) \.{\defeq}}%
 \@x{\@s{49.19} \{ p \.{\in} OnKernel ( kernel ) \.{:} status [ p ]
 \.{=}\@w{waiting\ read} \}}%
 \@x{\@s{32.8} Bumped ( kernel ) \.{\defeq} \{ p \.{\in} OnKernel ( kernel )
 \.{:}}%
\@x{\@s{49.19} \.{\land}\@s{4.1} status [ p ] \.{=}\@w{waiting\ read}}%
 \@x{\@s{49.19} \.{\land}\@s{4.10} \E\, t \.{\in} LogTime \.{:} \E\, d \.{\in}
 TcpData \.{:} {\langle} ltime [ p ] ,\, t ,\, d {\rangle} \.{\in} bumps [
 PID ( p ) ] \}}%
\@x{\@s{32.8} BumpedTo ( p ) \.{\defeq}}%
 \@x{\@s{49.19} {\CHOOSE} t \.{\in} LogTime \.{:} \E\, d \.{\in} TcpData \.{:}
 {\langle} ltime [ p ] ,\, t ,\, d {\rangle} \.{\in} bumps [ PID ( p ) ]}%
\@x{\@s{32.8} BumpData ( p ) \.{\defeq}}%
 \@x{\@s{49.19} {\CHOOSE} d \.{\in} TcpData \.{:} \E\, t \.{\in} LogTime \.{:}
 {\langle} ltime [ p ] ,\, t ,\, d {\rangle} \.{\in} bumps [ PID ( p ) ]}%
\@x{\@s{32.8} IsNextProc ( kernel ,\, p ) \.{\defeq}}%
 \@x{\@s{49.19} \.{\land}\@s{4.1} \A\, q \.{\in} Running ( kernel ) \.{\cup}
 WaitingSync ( kernel ) \.{:}}%
 \@x{\@s{75.73} q \.{\neq} p \.{\implies} Less ( p ,\, ltime [ p ] ,\, q ,\,
 ltime [ q ] )}%
 \@x{\@s{49.19} \.{\land}\@s{4.10} \A\, q \.{\in} Bumped ( kernel ) \.{:} Less
 ( p ,\, ltime [ p ] ,\, q ,\, BumpedTo ( q ) )}%
 \@x{\@s{32.8} BumpTo \.{\defeq} {\CHOOSE} i \.{\in} LogTime \.{:} \A\, p
 \.{\in} P \.{:} ltime [ p ] \.{<} i}%
\@x{\@s{16.4} \}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@macro} EnterRead ( p ) \{}%
\@x{\@s{32.8} status [ p ] \.{:=}\@w{waiting\ read} {\p@semicolon}}%
\@x{\@s{16.4} \}}%
\@x{\@s{16.4} {\p@macro} EnterSync ( p ) \{}%
\@x{\@s{32.8} status [ p ] \.{:=}\@w{waiting\ sync} {\p@semicolon}}%
\@x{\@s{16.4} \}}%
\@x{\@s{16.4} {\p@macro} ExitSync ( p ) \{}%
\@x{\@s{32.8} ltime [ p ] \.{:=} ltime [ p ] \.{+} 1 {\p@semicolon}}%
\@x{\@s{16.4} \}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} {\p@process} ( worker \.{\in} P ) \{}%
\@x{\@s{56.88} ww1\@s{.5}\textrm{:}\@s{3} {\p@while} ( {\TRUE} ) \{}%
\@x{\@s{95.72} EnterSync ( self )\@s{3.33} {\p@semicolon}}%
 \@x{\@s{56.88} ww2\@s{.5}\textrm{:}\@s{3}\@s{13.20} {\p@await} Run ( self )
 {\p@semicolon}}%
 \@x{\@s{56.88} ww3\@s{.5}\textrm{:}\@s{3}\@s{13.20} {\p@if} ( Len (
 requestQueue [ Ker ( self ) ] ) \.{>} 0 ) \{}%
 \@x{\@s{114.25} handledSocket [ self ] \.{:=} requestQueue [ Ker ( self ) ] [
 1 ] {\p@semicolon}}%
 \@x{\@s{114.25} requestQueue [ Ker ( self ) ] \.{:=} Shift ( requestQueue [
 Ker ( self ) ] ) {\p@semicolon}}%
\@x{\@s{95.72} \} {\p@semicolon}}%
 \@x{\@s{56.88} ww4\@s{.5}\textrm{:}\@s{3}\@s{13.20} ExitSync ( self )
 {\p@semicolon}}%
 \@x{\@s{56.88} ww5\@s{.5}\textrm{:}\@s{3}\@s{13.20} {\p@if} ( handledSocket [
 self ] \.{\neq} \.{-} 1 ) \{}%
 \@x{\@s{95.72} ww9\@s{.5}\textrm{:}\@s{3}\@s{12.29} {\p@while} ( Len (
 tcpBuff [ Ker ( self ) ] [ handledSocket [ self ] ] ) \.{>} 0 ) \{}%
\@x{\@s{150.96} EnterRead ( self )\@s{2.46} {\p@semicolon}}%
 \@x{\@s{112.12} ww10\@s{.5}\textrm{:}\@s{3}\@s{8.2} {\p@await} Run ( self )
 {\p@semicolon}}%
\@x{\@s{150.96} EnterSync ( self )\@s{3.33} {\p@semicolon}}%
 \@x{\@s{112.12} ww11\@s{.5}\textrm{:}\@s{3}\@s{8.2} {\p@await} Run ( self )
 {\p@semicolon}}%
\@x{\@s{150.96} file [ Ker ( self ) ] \.{:=}}%
 \@x{\@s{164.49} Append ( file [ Ker ( self ) ] ,\, {\langle} PID ( self ) ,\,
 reads [ self ] {\rangle} ) {\p@semicolon}}%
 \@x{\@s{112.12} ww12\@s{.5}\textrm{:}\@s{3}\@s{8.19} ExitSync ( self )
 {\p@semicolon}}%
\@x{\@s{112.12} \}}%
\@x{\@s{95.72} \} {\p@semicolon}}%
 \@x{\@s{56.88} ww13\@s{.5}\textrm{:}\@s{3}\@s{8.19} handledSocket [ self ]
 \.{:=} \.{-} 1 {\p@semicolon}}%
\@x{\@s{56.88} \} {\p@semicolon}}%
\@x{\@s{32.8} \}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@process} ( scheduler \.{\in} \{ {\langle} k ,\,
 SchedulerPID {\rangle} \.{:} k \.{\in} Kernel \} ) \{}%
\@x{\@s{32.8} s1\@s{.5}\textrm{:}\@s{3}\@s{7.89} {\p@while} ( {\TRUE} ) \{}%
\@x{\@s{73.28} {\p@either} \{}%
\@y{\@s{0}%
 Schedule a process waiting for synchronization:
}%
\@xx{}%
 \@x{\@s{89.68} {\p@with} ( p \.{\in} \{ p \.{\in} WaitingSync ( Ker ( self )
 ) \.{:}}%
\@x{\@s{125.50} IsNextProc ( Ker ( self ) ,\, p ) \} ) \{}%
\@x{\@s{106.08} status [ p ] \.{:=}\@w{running} \} \}}%
\@x{\@s{73.28} {\p@or} \{}%
\@y{\@s{0}%
 Bump a process waiting for a read:
}%
\@xx{}%
\@x{\@s{91.70} {\p@with} ( p \.{\in} WaitingRead ( Ker ( self ) ) ) \{}%
\@x{\@s{108.10} {\p@if} ( Ker ( self ) \.{=} Primary ) \{}%
\@y{\@s{0}%
 On the primary.
}%
\@xx{}%
...
\@xx{}%
\@x{\@s{124.50} bumps [ PID ( p ) ] \.{:=}}%
 \@x{\@s{140.90} bumps [ PID ( p ) ] \.{\cup} \{ {\langle} ltime [ p ] ,\,
 BumpTo ,\, tcpBuff [ Ker ( self ) ] [ handledSocket [ p ] ] [ 1 ] {\rangle}
 \} {\p@semicolon}}%
\@x{\@s{124.50} ltime [ p ] \.{:=} BumpTo {\p@semicolon}}%
\@x{\@s{108.10} \} {\p@else} \{}%
\@y{\@s{0}%
 On a replica:
}%
...
\@xx{}%
 \@x{\@s{114.8} {\p@await} p \.{\in} Bumped ( Ker ( self ) ) \.{\land}
 BumpData ( p ) \.{=} tcpBuff [ Ker ( self ) ] [ handledSocket [ p ] ] [ 1 ]
 {\p@semicolon}}%
\@x{\@s{114.8} ltime [ p ] \.{:=} BumpedTo ( p ) {\p@semicolon}}%
\@y{\@s{0}%
 Bump the process
}%
\@xx{}%
\@x{\@s{98.39} \} {\p@semicolon}}%
 \@x{\@s{98.39} reads [ p ] \.{:=} tcpBuff [ Ker ( self ) ] [ handledSocket [
 p ] ] [ 1 ] {\p@semicolon}}%
\@x{\@s{98.39} tcpBuff [ Ker ( self ) ] [ handledSocket [ p ] ] \.{:=}}%
 \@x{\@s{114.79} Shift ( tcpBuff [ Ker ( self ) ] [ handledSocket [ p ] ] )
 {\p@semicolon}}%
\@x{\@s{98.39} status [ p ] \.{:=}\@w{running} {\p@semicolon}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ {\VARIABLES} status ,\, ltime ,\, file ,\, bumps ,\, reads ,\, tcpBuff
 ,\, socketQueue ,\,}%
\@x{\@s{51.42} requestQueue ,\, handledSocket ,\, connections ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
\@x{ Run ( p ) \.{\defeq} status [ p ] \.{=}\@w{running}}%
 \@x{ Running ( kernel ) \.{\defeq} \{ p \.{\in} OnKernel ( kernel ) \.{:} Run
 ( p ) \}}%
\@x{ WaitingSync ( kernel ) \.{\defeq}}%
 \@x{\@s{16.4} \{ p \.{\in} OnKernel ( kernel ) \.{:} status [ p ]
 \.{=}\@w{waiting\ sync} \}}%
\@x{ WaitingRead ( kernel ) \.{\defeq}}%
 \@x{\@s{16.4} \{ p \.{\in} OnKernel ( kernel ) \.{:} status [ p ]
 \.{=}\@w{waiting\ read} \}}%
\@x{ Bumped ( kernel ) \.{\defeq} \{ p \.{\in} OnKernel ( kernel ) \.{:}}%
\@x{\@s{16.4} \.{\land}\@s{4.1} status [ p ] \.{=}\@w{waiting\ read}}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} \E\, t \.{\in} LogTime \.{:} \E\, d \.{\in}
 TcpData \.{:} {\langle} ltime [ p ] ,\, t ,\, d {\rangle} \.{\in} bumps [
 PID ( p ) ] \}}%
\@x{ BumpedTo ( p ) \.{\defeq}}%
 \@x{\@s{16.4} {\CHOOSE} t \.{\in} LogTime \.{:} \E\, d \.{\in} TcpData \.{:}
 {\langle} ltime [ p ] ,\, t ,\, d {\rangle} \.{\in} bumps [ PID ( p ) ]}%
\@x{ BumpData ( p ) \.{\defeq}}%
 \@x{\@s{16.4} {\CHOOSE} d \.{\in} TcpData \.{:} \E\, t \.{\in} LogTime \.{:}
 {\langle} ltime [ p ] ,\, t ,\, d {\rangle} \.{\in} bumps [ PID ( p ) ]}%
\@x{ IsNextProc ( kernel ,\, p ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{4.1} \A\, q \.{\in} Running ( kernel ) \.{\cup}
 WaitingSync ( kernel ) \.{:}}%
 \@x{\@s{42.93} q \.{\neq} p \.{\implies} Less ( p ,\, ltime [ p ] ,\, q ,\,
 ltime [ q ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} \A\, q \.{\in} Bumped ( kernel ) \.{:} Less
 ( p ,\, ltime [ p ] ,\, q ,\, BumpedTo ( q ) )}%
 \@x{ BumpTo \.{\defeq} {\CHOOSE} i \.{\in} LogTime \.{:} \A\, p \.{\in} P
 \.{:} ltime [ p ] \.{<} i}%
\@pvspace{16.0pt}%
 \@x{ vars \.{\defeq} {\langle} status ,\, ltime ,\, file ,\, bumps ,\, reads
 ,\, tcpBuff ,\, socketQueue ,\,}%
 \@x{\@s{41.61} requestQueue ,\, handledSocket ,\, connections ,\, pc
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ProcSet \.{\defeq} ( P ) \.{\cup} ( \{ {\langle} k ,\, SchedulerPID
 {\rangle} \.{:} k \.{\in} Kernel \} )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} status \.{=} [ p \.{\in} P \.{\mapsto}\@w{running}
 ]}%
\@x{\@s{35.70} \.{\land} ltime \.{=} [ p \.{\in} P \.{\mapsto} InitLogTime ]}%
 \@x{\@s{35.70} \.{\land} file \.{=} [ k \.{\in} Kernel \.{\mapsto} {\langle}
 {\rangle} ]}%
\@x{\@s{35.70} \.{\land} bumps \.{=} [ p \.{\in} Pid \.{\mapsto} \{ \} ]}%
 \@x{\@s{35.70} \.{\land} reads\@s{5.23} \.{=} [ p \.{\in} P \.{\mapsto} \.{-}
 1 ]}%
 \@x{\@s{35.70} \.{\land} tcpBuff \.{=} [ k \.{\in} Kernel \.{\mapsto}
 TcpMultiStream ]}%
 \@x{\@s{35.70} \.{\land} socketQueue \.{=} [ k \.{\in} Kernel \.{\mapsto}
 {\langle} {\rangle} ]}%
 \@x{\@s{35.70} \.{\land} requestQueue \.{=} [ k \.{\in} Kernel \.{\mapsto} [
 r \.{\in} 1 \.{\dotdot} Requests \.{\mapsto} r ] ]}%
 \@x{\@s{35.70} \.{\land} handledSocket \.{=} [ p \.{\in} P \.{\mapsto} \.{-}
 1 ]}%
 \@x{\@s{35.70} \.{\land} connections \.{=} [ k \.{\in} Kernel \.{\mapsto}
 {\langle} {\rangle} ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto} {\CASE}
 self \.{\in} P \.{\rightarrow}\@w{ww1}}%
 \@x{\@s{160.39} {\Box}\@s{10.30} self \.{\in} \{ {\langle} k ,\, SchedulerPID
 {\rangle} \.{:} k \.{\in} Kernel \} \.{\rightarrow}\@w{s1} ]}%
\@pvspace{8.0pt}%
\@x{ ww1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww1}}%
 \@x{\@s{62.46} \.{\land} status \.{'} \.{=} [ status {\EXCEPT} {\bang} [ self
 ] \.{=}\@w{waiting\ sync} ]}%
 \@x{\@s{62.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww2} ]}%
 \@x{\@s{62.46} \.{\land} {\UNCHANGED} {\langle} ltime ,\, file ,\, bumps ,\,
 reads ,\, tcpBuff ,\, socketQueue ,\,}%
\@x{\@s{136.05} requestQueue ,\, handledSocket ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww2 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww2}}%
\@x{\@s{62.46} \.{\land} Run ( self )}%
 \@x{\@s{62.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww3} ]}%
 \@x{\@s{62.46} \.{\land} {\UNCHANGED} {\langle} status ,\, ltime ,\, file ,\,
 bumps ,\, reads ,\, tcpBuff ,\,}%
\@x{\@s{136.05} socketQueue ,\, requestQueue ,\, handledSocket ,\,}%
\@x{\@s{136.05} connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww3 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww3}}%
\@x{\@s{62.46} \.{\land} {\IF} Len ( requestQueue [ Ker ( self ) ] ) \.{>} 0}%
 \@x{\@s{85.72} \.{\THEN} \.{\land} handledSocket \.{'} \.{=} [ handledSocket
 {\EXCEPT} {\bang} [ self ] \.{=} requestQueue [ Ker ( self ) ] [ 1 ] ]}%
 \@x{\@s{117.03} \.{\land} requestQueue \.{'} \.{=} [ requestQueue {\EXCEPT}
 {\bang} [ Ker ( self ) ] \.{=} Shift ( requestQueue [ Ker ( self ) ] ) ]}%
\@x{\@s{85.72} \.{\ELSE} \.{\land} {\TRUE}}%
 \@x{\@s{117.03} \.{\land} {\UNCHANGED} {\langle} requestQueue ,\,
 handledSocket {\rangle}}%
 \@x{\@s{62.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww4} ]}%
 \@x{\@s{62.46} \.{\land} {\UNCHANGED} {\langle} status ,\, ltime ,\, file ,\,
 bumps ,\, reads ,\, tcpBuff ,\,}%
\@x{\@s{136.05} socketQueue ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww4 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww4}}%
 \@x{\@s{62.46} \.{\land} ltime \.{'} \.{=} [ ltime {\EXCEPT} {\bang} [ self ]
 \.{=} ltime [ self ] \.{+} 1 ]}%
 \@x{\@s{62.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww5} ]}%
 \@x{\@s{62.46} \.{\land} {\UNCHANGED} {\langle} status ,\, file ,\, bumps ,\,
 reads ,\, tcpBuff ,\, socketQueue ,\,}%
\@x{\@s{136.05} requestQueue ,\, handledSocket ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww5 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww5}}%
\@x{\@s{62.46} \.{\land} {\IF} handledSocket [ self ] \.{\neq} \.{-} 1}%
 \@x{\@s{85.72} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{ww9} ]}%
 \@x{\@s{85.72} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{ww13} ]}%
 \@x{\@s{62.46} \.{\land} {\UNCHANGED} {\langle} status ,\, ltime ,\, file ,\,
 bumps ,\, reads ,\, tcpBuff ,\,}%
\@x{\@s{136.05} socketQueue ,\, requestQueue ,\, handledSocket ,\,}%
\@x{\@s{136.05} connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww9 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww9}}%
 \@x{\@s{62.46} \.{\land} {\IF} Len ( tcpBuff [ Ker ( self ) ] [ handledSocket
 [ self ] ] ) \.{>} 0}%
 \@x{\@s{85.72} \.{\THEN} \.{\land} status \.{'} \.{=} [ status {\EXCEPT}
 {\bang} [ self ] \.{=}\@w{waiting\ read} ]}%
 \@x{\@s{117.03} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww10} ]}%
 \@x{\@s{85.72} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{ww13} ]}%
\@x{\@s{117.03} \.{\land} {\UNCHANGED} status}%
 \@x{\@s{62.46} \.{\land} {\UNCHANGED} {\langle} ltime ,\, file ,\, bumps ,\,
 reads ,\, tcpBuff ,\, socketQueue ,\,}%
\@x{\@s{136.05} requestQueue ,\, handledSocket ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww10 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww10}}%
\@x{\@s{67.46} \.{\land} Run ( self )}%
 \@x{\@s{67.46} \.{\land} status \.{'} \.{=} [ status {\EXCEPT} {\bang} [ self
 ] \.{=}\@w{waiting\ sync} ]}%
 \@x{\@s{67.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww11} ]}%
 \@x{\@s{67.46} \.{\land} {\UNCHANGED} {\langle} ltime ,\, file ,\, bumps ,\,
 reads ,\, tcpBuff ,\, socketQueue ,\,}%
\@x{\@s{141.05} requestQueue ,\, handledSocket ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww11 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww11}}%
\@x{\@s{67.46} \.{\land} Run ( self )}%
 \@x{\@s{67.46} \.{\land} file \.{'} \.{=} [ file {\EXCEPT} {\bang} [ Ker (
 self ) ] \.{=} Append ( file [ Ker ( self ) ] ,\, {\langle} PID ( self ) ,\,
 reads [ self ] {\rangle} ) ]}%
 \@x{\@s{67.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww12} ]}%
 \@x{\@s{67.46} \.{\land} {\UNCHANGED} {\langle} status ,\, ltime ,\, bumps
 ,\, reads ,\, tcpBuff ,\,}%
\@x{\@s{141.05} socketQueue ,\, requestQueue ,\, handledSocket ,\,}%
\@x{\@s{141.05} connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww12 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww12}}%
 \@x{\@s{67.46} \.{\land} ltime \.{'} \.{=} [ ltime {\EXCEPT} {\bang} [ self ]
 \.{=} ltime [ self ] \.{+} 1 ]}%
 \@x{\@s{67.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww9} ]}%
 \@x{\@s{67.46} \.{\land} {\UNCHANGED} {\langle} status ,\, file ,\, bumps ,\,
 reads ,\, tcpBuff ,\, socketQueue ,\,}%
\@x{\@s{141.05} requestQueue ,\, handledSocket ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ww13 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{ww13}}%
 \@x{\@s{67.46} \.{\land} handledSocket \.{'} \.{=} [ handledSocket {\EXCEPT}
 {\bang} [ self ] \.{=} \.{-} 1 ]}%
 \@x{\@s{67.46} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ww1} ]}%
 \@x{\@s{67.46} \.{\land} {\UNCHANGED} {\langle} status ,\, ltime ,\, file ,\,
 bumps ,\, reads ,\, tcpBuff ,\,}%
\@x{\@s{141.05} socketQueue ,\, requestQueue ,\, connections {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ worker ( self ) \.{\defeq} ww1 ( self ) \.{\lor} ww2 ( self ) \.{\lor}
 ww3 ( self ) \.{\lor} ww4 ( self )}%
 \@x{\@s{92.92} \.{\lor} ww5 ( self ) \.{\lor} ww9 ( self ) \.{\lor} ww10 (
 self ) \.{\lor} ww11 ( self )}%
\@x{\@s{92.92} \.{\lor} ww12 ( self ) \.{\lor} ww13 ( self )}%
\@pvspace{8.0pt}%
\@x{ s1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{s1}}%
 \@x{\@s{53.00} \.{\land} \.{\lor} \.{\land} \E\, p \.{\in}\@s{16.4} \{ p
 \.{\in} WaitingSync ( Ker ( self ) ) \.{:}}%
\@x{\@s{115.70} IsNextProc ( Ker ( self ) ,\, p ) \} \.{:}}%
 \@x{\@s{94.53} status \.{'} \.{=} [ status {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{running} ]}%
 \@x{\@s{75.22} \.{\land} {\UNCHANGED} {\langle} ltime ,\, bumps ,\, reads ,\,
 tcpBuff {\rangle}}%
 \@x{\@s{64.11} \.{\lor} \.{\land} \E\, p \.{\in} WaitingRead ( Ker ( self ) )
 \.{:}}%
\@x{\@s{94.53} \.{\land} {\IF} Ker ( self ) \.{=} Primary}%
 \@x{\@s{117.80} \.{\THEN} \.{\land} bumps \.{'} \.{=} [ bumps {\EXCEPT}
 {\bang} [ PID ( p ) ] \.{=} bumps [ PID ( p ) ] \.{\cup} \{ {\langle} ltime
 [ p ] ,\, BumpTo ,\, tcpBuff [ Ker ( self ) ] [ handledSocket [ p ] ] [ 1 ]
 {\rangle} \} ]}%
 \@x{\@s{149.11} \.{\land} ltime \.{'}\@s{5.69} \.{=} [ ltime {\EXCEPT}
 {\bang} [ p ] \.{=} BumpTo ]}%
 \@x{\@s{117.80} \.{\ELSE} \.{\land} p \.{\in} Bumped ( Ker ( self ) )
 \.{\land} BumpData ( p ) \.{=} tcpBuff [ Ker ( self ) ] [ handledSocket [ p
 ] ] [ 1 ]}%
 \@x{\@s{149.11} \.{\land} ltime \.{'}\@s{5.69} \.{=} [ ltime {\EXCEPT}
 {\bang} [ p ] \.{=} BumpedTo ( p ) ]}%
\@x{\@s{149.11} \.{\land} bumps \.{'} \.{=} bumps}%
 \@x{\@s{94.53} \.{\land} reads \.{'} \.{=} [ reads {\EXCEPT} {\bang} [ p ]
 \.{=} tcpBuff [ Ker ( self ) ] [ handledSocket [ p ] ] [ 1 ] ]}%
 \@x{\@s{94.53} \.{\land} tcpBuff \.{'} \.{=} [ tcpBuff {\EXCEPT} {\bang} [
 Ker ( self ) ] [ handledSocket [ p ] ] \.{=} Shift ( tcpBuff [ Ker ( self )
 ] [ handledSocket [ p ] ] ) ]}%
 \@x{\@s{94.53} \.{\land} status \.{'} \.{=} [ status {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{running} ]}%
 \@x{\@s{53.00} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{s1} ]}%
 \@x{\@s{53.00} \.{\land} {\UNCHANGED} {\langle} file ,\, socketQueue ,\,
 requestQueue ,\, handledSocket ,\,}%
\@x{\@s{126.59} connections {\rangle}}%
\@pvspace{8.0pt}%
\@x{ scheduler ( self ) \.{\defeq} s1 ( self )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} P \.{:} worker ( self ) )}%
 \@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} \{ {\langle} k ,\, SchedulerPID
 {\rangle} \.{:} k \.{\in} Kernel \} \.{:} scheduler ( self ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ RequestSynchronized \.{\defeq} \A\, k1 ,\, k2 \.{\in} Kernel \.{:}}%
 \@x{\@s{16.4} \.{\lor}\@s{4.1} Prefix ( socketQueue [ k1 ] ,\, socketQueue [
 k2 ] )}%
 \@x{\@s{16.4} \.{\lor}\@s{4.09} Prefix ( socketQueue [ k2 ] ,\, socketQueue [
 k1 ] )}%
\@pvspace{8.0pt}%
\@x{ FilesSynchronized \.{\defeq} \A\, k1 ,\, k2 \.{\in} Kernel \.{:}}%
\@x{\@s{16.4} \.{\lor}\@s{4.1} Prefix ( file [ k1 ] ,\, file [ k2 ] )}%
\@x{\@s{16.4} \.{\lor}\@s{4.09} Prefix ( file [ k2 ] ,\, file [ k1 ] )}%
\@pvspace{8.0pt}%
\@x{ ConnectionSynchronized \.{\defeq} \A\, k1 ,\, k2 \.{\in} Kernel \.{:}}%
 \@x{\@s{16.4} \.{\lor}\@s{4.1} Prefix ( connections [ k1 ] ,\, connections [
 k2 ] )}%
 \@x{\@s{16.4} \.{\lor}\@s{4.09} Prefix ( connections [ k2 ] ,\, connections [
 k1 ] )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 23 14:57:58 \ensuremath{EDT} 2015 by \ensuremath{wen
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Mon}
 \ensuremath{Oct} 19 20:54:09 \ensuremath{EDT} 2015 by \ensuremath{nano
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Fri}
 \ensuremath{Oct} 16 21:28:32 \ensuremath{EDT} 2015 by \ensuremath{nano
}%
\end{cpar}%
\end{lcom}%
\end{document}
